...
.PHONY: setup dev demo-reset test presign seed revoke tamper untamper verify-chain bench
...
bench: ## Phase 4 B-9:實測 presign 張數 + 簽發/驗證耗時(真跑既有簽發/驗證程式碼,量測完以 seed 歸位)
